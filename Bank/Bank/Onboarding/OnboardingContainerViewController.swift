...
//  Bank
//
//  Created by Erasmo J.F Da Silva on 14/03/23.
//
...
class OnboardingContainerViewController: UIViewController {
    ...
    override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
        ...
        let page1 = OnboardingViewController(heroImageName: "delorean", titleText: "Bank is faster, easier to use, and has a brand new look and feel that will make you feel like you are back in 80s.")
        let page2 = OnboardingViewController(heroImageName: "world", titleText: "Move your money arround the world quickly and securely.")
        let page3 = OnboardingViewController(heroImageName: "thumbs", titleText: "Learn more at www.bank.com")
