...
//  Bank
//
//  Created by Erasmo J.F Da Silva on 04/04/23.
//
...
extension AccountSummaryCell {
    ...
    private func setup() {
        ...
        balanceAmountLabel.attributedText = makeFormattedBalance(dollars: "930,450", cents: "50")
...
extension AccountSummaryCell {
    func configure(with vm: ViewModel) {
        ...
        case .CreditCard:
            ...
            balanceLabel.text = "Visa balance"
        case .Investment:
            underlineView.backgroundColor = .systemPurple
            balanceLabel.text = "Value Investment"
        }
    }
}
